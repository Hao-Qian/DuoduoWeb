...
export class AppComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(){
    ...
    this.menuItems = [
      {label: 'Profile', icon: 'fa-users', routerLink: ['/profiles'], command: (event) => handleSelected(event)},
      {label: 'Videos', icon: 'fa-users', routerLink: ['/videos'], command: (event) => handleSelected(event)},
      {label: 'Photos', icon: 'fa-users', routerLink: ['/photos'], command: (event) => handleSelected(event)},
